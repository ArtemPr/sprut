 ...
 */
final class Version20220726132530 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE subdivisions (id INT NOT NULL, subdivisions_name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    }
