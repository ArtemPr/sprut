 ...
 */
final class Version20220727123930 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE directions (id INT NOT NULL, direction_name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
    }
